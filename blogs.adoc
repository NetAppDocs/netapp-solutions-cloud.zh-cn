...
* link:https://www.netapp.com/blog/aws-fsxo-blg-configure-hybrid-cloud-with-fsx-for-netapp-ontap-and-vmware-cloud-on-aws-sddc-using-vmware-hcx/["使用 VMware HCX 配置带有 FSx ONTAP和 VMware Cloud on AWS SDDC 的混合云"]
...
* link:https://www.netapp.com/blog/vmware-optimize-storage-workloads/["优化任何云中的存储和数据密集型 VMware 工作负载"]
* link:https://www.netapp.com/blog/vmware-migrate-workloads-azure/["VMware 工作负载迁移到 Azure VMware Solution？请先阅读此内容。"]
