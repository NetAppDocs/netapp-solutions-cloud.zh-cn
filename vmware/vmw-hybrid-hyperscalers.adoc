...
查看详细信息link:azure-guest.html["AVS 的来宾连接存储选项"]。查看详细信息link:azure-native-nfs-datastore-option.html["AVS 的补充 NFS 数据存储选项"]。
...
查看详细信息link:gcp-guest.html["GCVE 的来宾连接存储选项"]。查看详细信息link:gcp-ncvs-datastore.html["GCVE 的补充 NFS 数据存储选项"]。
