...
**NetApp Trident Protect**，作为 NetApp Trident 的免费附加组件，提供先进的应用程序数据管理功能，增强由 NetApp ONTAP 存储系统支持的有状态 Kubernetes 应用程序的功能和可用性。Trident Protect 简化了跨公共云和本地环境的容器化工作负载的管理、保护和移动。它还通过其 API 和 CLI 提供强大的自动化功能。
