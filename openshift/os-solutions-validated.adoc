...
[role="lead"]
该解决方案使用 OpenShift 容器平台 (OCP)、OpenShift 高级集群管理器 (ACM)、NetApp ONTAP、NetApp BlueXP 和 NetApp Trident Protect 测试和验证迁移和集中式数据保护。
...
* 使用 Trident Protect 保护应用程序并支持本地集群之间的迁移。
...
* 使用 Trident Protect 保护应用程序，并支持本地集群和 AWS 中自管理 OpenShift 集群之间的迁移。
...
* 使用 Trident Protect 保护应用程序，并支持本地集群和 Google Cloud OpenShift 集群之间的迁移。
...
* 使用 Trident Protect 保护应用程序并支持本地和 Azure 中的 OpenShift 集群之间的迁移。
