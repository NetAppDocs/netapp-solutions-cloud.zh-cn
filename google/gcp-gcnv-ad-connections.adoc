...
要为 NFS Kerberos 启用 AES 加密， https://docs.cloud.google.com/netapp/volumes/docs/plan-and-prepare/security-considerations["请参阅Google Cloud NetApp Volumes文档"^]。
